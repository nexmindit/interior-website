...
const socialLinks = [
  ...
  },
  {
    ...
    icon: Instagram,
    hover: "hover:border-[#E4405F] hover:text-[#E4405F]",
  },
  {
    label: "TikTok",
    href: "https://www.tiktok.com",
    icon: ArrowUpRight,
    hover: "hover:border-black hover:text-black",
  },
  {
    label: "Line",
    href: "https://lin.ee/rEItfUT3",
    icon: MessageCircle,
  ...
  const contactDetails = [
    {
      labelKey: "visitUs",
      value:
        "Ocean Tower II Building, 75/44 (23A Unit B) ชั้น 23, Sukhumvit 19 (Wattana), Klongtoey Nua, Bangkok 10110 Thailand",
      icon: MapPin,
    },
    {
      labelKey: "call",
      ...
      <main className="pt-28 pb-20">
        <section className="px-6 md:px-12">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mt-5 text-lg text-zinc-600">{t("description")}</p>
          </div>
        </section>
                      ...
                      >
                        ...
                        <div>
                          ...
                          {href ? (
                            <a
                              href={href}
                              className="mt-1 inline-block text-base font-semibold hover:text-gray-600 transition-colors"
                            >
                              {value}
                            </a>
                          ) : (
            ...
            <div className="rounded-xl border border-gray-100 bg-gray-50 p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
              ...
              >
                <input
                  type="hidden"
                  name="_subject"
                  value="New Contact Form Submission - Regenlanes"
                />
                <input type="hidden" name="_captcha" value="false" />
                <input type="hidden" name="_template" value="table" />
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm uppercase tracking-[0.2em] text-gray-500">
                      {t("name")}
                    </label>
                    <input
                      type="text"
